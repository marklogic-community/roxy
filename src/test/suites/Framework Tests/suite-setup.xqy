...
test:load-test-file("different-layout.html.xqy", xdmp:modules-database(), fn:concat(xdmp:modules-root(), "app/views/tester/different-layout.html.xqy")),
...
test:load-test-file("different-layout.html", xdmp:modules-database(), fn:concat(xdmp:modules-root(), "app/views/layouts/different-layout.html.xqy")),
